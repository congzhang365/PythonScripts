...
'''
This script is to summarise the lengths of the audio in the in_path folder. This folder must have subfolders.
The output file is a txt file with file names and durations, delimited by tabs.

To run this script you need to install praat-parselmouth
